...
if [[ `lsb_release -rs` == "16.04" ]]; then
    echo "Downloading Zimbra Collaboration 8.7.1 for Ubuntu 16.04"
    wget https://files.zimbra.com/downloads/8.7.5_GA/zcs-8.7.5_GA_1764.UBUNTU16_64.20170314032533.tgz
    tar xzvf zcs-*
...
if [[ `lsb_release -rs` == "14.04" ]]; then
    echo "Downloading Zimbra Collaboration 8.7.1 for Ubuntu 14.04"
    wget https://files.zimbra.com/downloads/8.7.1_GA/zcs-8.7.1_GA_1670.UBUNTU14_64.20161025045105.tgz
    tar xzvf zcs-*
    echo "Installing Zimbra Collaboration just the Software"
    cd /tmp/zcs/zcs-* && ./install.sh -s < /tmp/zcs/installZimbra-keystrokes
    echo "Installing Zimbra Collaboration injecting the configuration"
